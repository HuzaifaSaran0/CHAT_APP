...
const path = window.location.pathname; // this line gets the current URL path 
// to determine if it's a login or signup page
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    if (isLogin) {
      ...
      const age = rawAge === "" ? null : parseInt(rawAge); // this line ensures age is null if not selected
